...
above is a static frame of that run (regenerate with `scripts/render_demo_svg.py`; an animated GIF
is available via `scripts/demo.tape` + [vhs](https://github.com/charmbracelet/vhs)).
